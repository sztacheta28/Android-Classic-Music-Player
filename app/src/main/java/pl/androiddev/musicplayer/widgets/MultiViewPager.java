package pl.androiddev.musicplayer.widgets;
...
public class MultiViewPager extends ViewPager {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, pl.androiddev.musicplayer.R.styleable.MultiViewPager);
        setMaxWidth(ta.getDimensionPixelSize(pl.androiddev.musicplayer.R.styleable.MultiViewPager_android_maxWidth, -1));
        setMaxHeight(ta.getDimensionPixelSize(pl.androiddev.musicplayer.R.styleable.MultiViewPager_android_maxHeight, -1));
        setMatchChildWidth(ta.getResourceId(pl.androiddev.musicplayer.R.styleable.MultiViewPager_matchChildWidth, 0));
        ta.recycle();
    }
