package pl.androiddev.musicplayer.nowplaying;
...
import pl.androiddev.musicplayer.adapters.BaseQueueAdapter;
import pl.androiddev.musicplayer.adapters.SlidingQueueAdapter;
import pl.androiddev.musicplayer.dataloaders.QueueLoader;
import pl.androiddev.musicplayer.listeners.MusicStateListener;
import pl.androiddev.musicplayer.timely.TimelyView;
import pl.androiddev.musicplayer.utils.Helpers;
import pl.androiddev.musicplayer.utils.PreferencesUtility;
import pl.androiddev.musicplayer.utils.SlideTrackSwitcher;
import pl.androiddev.musicplayer.utils.PlayerUtils;
import pl.androiddev.musicplayer.widgets.PlayPauseButton;
import pl.androiddev.musicplayer.widgets.PlayPauseDrawable;
...
public class BaseNowplayingFragment extends Fragment implements MusicStateListener {
        ...
        public void run() {
            ...
            if (mProgress != null) {
                ...
                if (elapsedtime != null && getActivity() != null)
                    elapsedtime.setText(PlayerUtils.makeShortTimeString(getActivity(), position / 1000));
            }
            overflowcounter--;
    ...
    public Runnable mUpdateElapsedTime = new Runnable() {
        ...
        public void run() {
            if (getActivity() != null) {
                String time = PlayerUtils.makeShortTimeString(getActivity(), MusicPlayer.position() / 1000);
                if (time.length() < 5) {
    ...
    public void updateShuffleState() {
        if (shuffle != null && getActivity() != null) {
            ...
            if (getActivity() != null) {
                ...
                } else builder.setColor(ContextCompat.getColor(getContext(), R.color.red_translucent));
            }
    ...
    public void updateSongDetails() {
        ...
        if (songduration != null && getActivity() != null)
            songduration.setText(PlayerUtils.makeShortTimeString(getActivity(), MusicPlayer.duration() / 1000));
