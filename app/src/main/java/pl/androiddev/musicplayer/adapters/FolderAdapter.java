...
import pl.androiddev.musicplayer.dataloaders.FolderLoader;
...
public class FolderAdapter extends RecyclerView.Adapter<FolderAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(final FolderAdapter.ItemHolder itemHolder, int i) {
        ...
        if (localItem.isDirectory()) {
            ...
            ImageLoader.getInstance().displayImage(PlayerUtils.getAlbumArtUri(song.albumId).toString(),
                    itemHolder.albumArt,
        ...
        public void onClick(View v) {
            ...
            if (f.isDirectory() && updateDataSetAsync(f)) {
                ...
                handler.postDelayed(() -> {
                    ...
                    MusicPlayer.playAll(mContext, ret, current, -1, PlayerUtils.IdType.NA, false);
                }, 100);
