...
public class PlaylistPagerFragment extends Fragment {
    ...
    private TextView playlistame, songcount, playlistnumber;
    ...
    private void setUpPlaylistDetails() {
        ...
        foreground.setBackgroundColor(ContextCompat.getColor(getContext(), foregroundColor));
    }
                    ...
                    switch (pageNumber) {
                        case 0:
                            ...
                            if (songCountInt != 0) {
                                ...
                                return PlayerUtils.getAlbumArtUri(firstAlbumID).toString();
                            } else return "nosongs";
                        case 1:
