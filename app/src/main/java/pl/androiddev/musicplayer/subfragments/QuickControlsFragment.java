package pl.androiddev.musicplayer.subfragments;
...
public class QuickControlsFragment extends Fragment implements MusicStateListener {
    ...
    public void updateNowplayingCard() {
        ...
        if (!duetoplaypause) {
            ImageLoader.getInstance().displayImage(PlayerUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), mAlbumArt,
