...
import pl.androiddev.musicplayer.helpers.MediaButtonIntentReceiver;
import pl.androiddev.musicplayer.helpers.MusicPlaybackTrack;
import pl.androiddev.musicplayer.permissions.Nammu;
import pl.androiddev.musicplayer.provider.MusicPlaybackState;
import pl.androiddev.musicplayer.provider.RecentStore;
import pl.androiddev.musicplayer.provider.SongPlayCount;
...
import pl.androiddev.musicplayer.utils.PlayerUtils.IdType;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "pl.androiddev.musicplayer.playstatechanged";
    public static final String POSITION_CHANGED = "pl.androiddev.musicplayer.positionchanged";
    public static final String META_CHANGED = "pl.androiddev.musicplayer.metachanged";
    public static final String QUEUE_CHANGED = "pl.androiddev.musicplayer.queuechanged";
    public static final String PLAYLIST_CHANGED = "pl.androiddev.musicplayer.playlistchanged";
    public static final String REPEATMODE_CHANGED = "pl.androiddev.musicplayer.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "pl.androiddev.musicplayer.shufflemodechanged";
    public static final String TRACK_ERROR = "pl.androiddev.musicplayer.trackerror";
    public static final String PLAYER_PACKAGE_NAME = "pl.androiddev.musicplayer";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "pl.androiddev.musicplayer.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "pl.androiddev.musicplayer.togglepause";
    public static final String PAUSE_ACTION = "pl.androiddev.musicplayer.pause";
    public static final String STOP_ACTION = "pl.androiddev.musicplayer.stop";
    public static final String PREVIOUS_ACTION = "pl.androiddev.musicplayer.previous";
    public static final String PREVIOUS_FORCE_ACTION = "pl.androiddev.musicplayer.previous.force";
    public static final String NEXT_ACTION = "pl.androiddev.musicplayer.next";
    public static final String REPEAT_ACTION = "pl.androiddev.musicplayer.repeat";
    public static final String SHUFFLE_ACTION = "pl.androiddev.musicplayer.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "pl.androiddev.musicplayer.refresh";
    ...
    private static final String SHUTDOWN = "pl.androiddev.musicplayer.shutdown";
    ...
    private void setUpMediaSession() {
        mSession = new MediaSessionCompat(this, "Classic music player");
    ...
    private void addToPlayList(final long[] list, int position, long sourceId, PlayerUtils.IdType sourceType) {
    ...
    private void doAutoShuffleUpdate() {
        ...
        for (int i = 0; i < toAdd; i++) {
            ...
            mPlaylist.add(new MusicPlaybackTrack(mAutoShuffleList[idx], -1, PlayerUtils.IdType.NA, -1));
            notify = true;
        }
        if (notify) {
            notifyChange(QUEUE_CHANGED);
    ...
    private void notifyChange(final String what) {
        ...
        musicIntent.setAction(what.replace(PLAYER_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
        ...
        if (mRemoteControlClient != null) {
            ...
            if (what.equals(META_CHANGED) || what.equals(QUEUE_CHANGED)) {
                ...
                if (mShowAlbumArtOnLockscreen) {
                    albumArt = ImageLoader.getInstance().loadImageSync(PlayerUtils.getAlbumArtUri(getAlbumId()).toString());
                    if (albumArt != null) {
    ...
    private Notification buildNotification() {
        ...
        Bitmap artwork;
        artwork = ImageLoader.getInstance().loadImageSync(PlayerUtils.getAlbumArtUri(getAlbumId()).toString());
        ...
        if (artwork != null && PlayerUtils.isLollipop())
                ...
                do {
                    TrackItem t = new TrackItem()
                            .setArt(ImageLoader.getInstance()
                                    .loadImageSync(PlayerUtils.getAlbumArtUri(c.getLong(c.getColumnIndexOrThrow(AudioColumns.ALBUM_ID))).toString()))
                            ...
                            .setDuration(PlayerUtils.makeShortTimeString(this, c.getInt(c.getColumnIndexOrThrow(AudioColumns.DURATION)) / 1000));
                    list.add(t.get());
                } while (c.moveToNext());
                try {
                ...
                try {
                    if (mCursor != null && shouldAddToPlaylist) {
                        ...
                        mPlaylist.add(new MusicPlaybackTrack(
                                mCursor.getLong(IDCOLIDX), -1, PlayerUtils.IdType.NA, -1));
                        notifyChange(QUEUE_CHANGED);
                        mPlayPos = 0;
                        mHistory.clear();
                    }
    ...
    public void open(final long[] list, final int position, long sourceId, PlayerUtils.IdType sourceType) {
        synchronized (this) {
            if (mShuffleMode == SHUFFLE_AUTO) {
